...
const CommitPathVisualizer: React.FC<CommitPathVisualizerProps> = ({ commitPath, setSelectedCommitId, selectedCommitId }) => {
                ...
                {commitPath.map((commit_id, index) => (
                    <React.Fragment key={index}>
                        ...
                        >
                            ...
                            <span
                                style={{
                                    backgroundColor: commit_id === selectedCommitId ? "#e9ecef" : "",
                                }}
