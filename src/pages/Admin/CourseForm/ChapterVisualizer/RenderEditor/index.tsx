...
const SectionToolbar: React.FC<SectionToolbarProps> = ({
	...
	const { moveSectionBackward, moveSectionForward, removeSection } =
		useCourse();
	return (
...
const RenderEditor: React.FC<RenderEditorProps> = ({ section, chapter }) => {
	if (section.type === 'code') {
		return (
			<div className="card p-2 mb-3">
				...
				<CodeEditor section={section as Code} />
			</div>
		);
	}
