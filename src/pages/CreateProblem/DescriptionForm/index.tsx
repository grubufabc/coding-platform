...
const DescriptionForm: React.FC<DescriptionFormProps> = ({ setDescription, setTitle, title }) => {
    ...
    return (
        <React.Fragment>
            ...
            <Input label={{ text: 'Título', id: 'title' }} placeholder="Título" className="mb-5" value={title} setValue={setTitle} />
